System.registerDynamic("npm:nestable2@1.5.0.json", [], true, function() {
  return {
...
System.registerDynamic('npm:nestable2@1.5.0/jquery.nestable.js', [], false, function ($__require, $__exports, $__module) {
...
System.registerDynamic("reactiveadmintemplate/scripts/modules/nestable.js", ["nestable"], true, function ($__require, exports, module) {
    'use strict';
    ...
    $(function () {
        ...
        var $nestable1 = $('#nestable1').nestable($.extend({}, nestableOptions, {
            group: 1,
            json: json,
            contentCallback: function (item) {
        ...
        var $nestable2 = $('#nestable2').nestable($.extend({}, nestableOptions, {
            group: 1
        })).on('change', updateOutput);
...
System.registerDynamic("reactiveadmintemplate/scripts/nestable.js", ["./app", "./modules/nestable"], true, function ($__require, exports, module) {
  'use strict';
