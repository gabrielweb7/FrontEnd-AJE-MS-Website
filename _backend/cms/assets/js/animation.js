System.registerDynamic("npm:velocity-animate@1.5.0/velocity.ui.js", [], false, function ($__require, $__exports, $__module) {
...
System.registerDynamic("reactiveadmintemplate/scripts/modules/animations.js", ["./dropdown/transition", "velocity", "velocity/velocity.ui"], true, function ($__require, exports, module) {
    'use strict';
     ...
     */
    $__require("./dropdown/transition");
    $__require("velocity");
    $__require("velocity/velocity.ui");
    $(function () {
        var $jsTransitionPanel = $('#js-transition-panel').find('.panel');
        var $jsTransition = $('#js-transition');
        $jsTransition.find('.animation-type select').change(function () {
            var $drop = $(this).parents('.select-dropdown').selectDropdown('hide').addClass('disabled');
        ...
        var $singlePanel = $('#single-transition-panel').find('.panel');
        var $singleTransition = $('#single-transition');
        $singleTransition.find('.animation-type select').change(function () {
            var duration = $singleTransition.find('.animation-duration select').val();
        ...
        var $doubledPanel = $('#doubled-transition-panel').find('.panel');
        var $doubledTransition = $('#doubled-transition');
        $doubledTransition.find('.animation-type1 select, .animation-type2 select').change(function () {
            var duration = $doubledTransition.find('.animation-duration select').val();
        ...
        var $groupedPanel = $('#grouped-transition-panel').find('.panel');
        var $groupedTransition = $('#grouped-transition');
        $groupedTransition.find('.animation-type select').change(function () {
            var duration = $groupedTransition.find('.animation-duration select').val();
            var interval = $groupedTransition.find('.animation-interval select').val();
        ...
        var $groupedDubledPanel = $('#grouped-doubled-transition-panel').find('.panel');
        var $groupedDubledTransition = $('#grouped-doubled-transition');
        $groupedDubledTransition.find('.animation-type1 select, .animation-type2 select').change(function () {
            var duration = $groupedDubledTransition.find('.animation-duration select').val();
            var interval = $groupedDubledTransition.find('.animation-interval select').val();
...
System.registerDynamic("reactiveadmintemplate/scripts/animation.js", ["./app", "./modules/animations"], true, function ($__require, exports, module) {
  'use strict';
