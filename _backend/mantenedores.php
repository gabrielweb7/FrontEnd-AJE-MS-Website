...
<?php 
	...
	$row = adminTextos::getRegister("identificadorFront = 'mantenedores'");
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-lg-12 col-md-12">
						<!-- page-single -->
						<div class="page-single page-mantenedores">
							...
							<div class="page-body">
								...
								<!-- inscrição -->
								<a href="./quero-ser-um-mantenedor" class="btn1 mg-top-20" style='margin: 0 auto;font-size:20px;'> QUERO SER UM MANTENEDOR </a>
