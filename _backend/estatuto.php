...
<?php 
	...
	$row = adminTextos::getRegister("identificadorFront = 'estatuto'");
					...
					<div class="col-lg-12 col-md-12">
							...
							<div class="page-single page-institucional">
								...
								<div class="page-body">
									...
									<!-- download pdf file -->
									<a href="./downloads/estatuto-social-ajems.pdf" target="_blank" class="btn1 mg-top-15"> Baixar estatuto em PDF </a>
